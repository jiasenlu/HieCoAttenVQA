...
local attention = require 'misc.attention_bak'
...
local layer, parent = torch.class('nn.rersive_atten', 'nn.Module')
function layer:__init(opt)
    parent.__init(self)
    self.atten_encode = attention.recursive_atten(512,512,1000)
